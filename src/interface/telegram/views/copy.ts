...
export const COPY = {
  ...
  back: 'Назад',
  skip: 'Пропустить',
  skipSticker: 'Без стикера',
  newCard: 'новый',
  promptName: 'Введите название материала:',
  promptRename: 'Введите новое название материала:',
  ...
  promptIcon: (name: string, amount: string) =>
    `${name} · ${amount} · просто баланс\n\nВыберите стикер:`,
  promptSetIcon: 'Выберите стикер:',
  topUpMenu: 'Пополнить',
  ...
  renameMaterial: 'Переименовать материал',
  changeSticker: 'Сменить стикер',
